...
Route::middleware(['auth', 'user-access:customer'])->group(function () {
    Route::group(['prefix' => 'customer/'], function () {
        ...
        // Route::post('/booking/{package}/store', [BookingController::class, 'store'])->name('customer.store.booking');
        Route::post('/booking/{id}/store', [BookingController::class, 'store'])->name('customer.store.booking');
