                ...
                <div class="card-body">
                    ...
                    @php
                        ...
                        $statusBadge = $isAvailable ? 
                            '<span class="badge bg-primary ms-2"><i class="fas fa-check-circle me-1"></i> Tersedia</span>' : 
                            '<span class="badge bg-secondary ms-2"><i class="fas fa-times-circle me-1"></i> Tidak tersedia</span>';
                    @endphp
